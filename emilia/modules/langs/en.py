...
# welcome
	...
	"Saya harus menghapus pesan selamat datang hingga dua hari.": "I should be deleting welcome messages up to two days old.",
	"Saat ini saya tidak menghapus pesan selamat datang yang lama!": "I'm currently not deleting old welcome messages!",
